    ...
    <div className="min-h-screen relative overflow-hidden" style={{
      ...
      <div className="min-h-screen relative z-20">
        <div className="flex justify-center gap-3 pt-0 mb-8">
          <img src="/house_g.svg" alt="Gryffindor" className="h-25 object-contain drop-shadow-lg" />
          <img src="/house_r.svg" alt="Ravenclaw" className="h-25 object-contain drop-shadow-lg" />
          <img src="/house_h.svg" alt="Hufflepuff" className="h-25 object-contain drop-shadow-lg" />
          <img src="/house_s.svg" alt="Slytherin" className="h-25 object-contain drop-shadow-lg" />
        </div>
